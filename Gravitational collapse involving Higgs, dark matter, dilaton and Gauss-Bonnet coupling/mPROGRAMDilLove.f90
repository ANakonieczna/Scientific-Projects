...
DO i=1,Nkoniec
   ...
   IF (H.LE.0) THEN
      ...
      WRITE(4,50) u,v(i),rnext(i),mEH,Qnext(i)
...
!END DO
!
!IF (MOD(licznik-1,coile3d).EQ.0) THEN
!   DO i=1,Nkoniec
!      IF (MOD(i,coile3d).EQ.0) THEN
!         WRITE(7,80) u,v(i),&
!          ObsED(s1prev(i),s2prev(i),hprev(i),q1prev(i),q2prev(i),yprev(i),aprev(i),p1prev(i),p2prev(i),xprev(i),rprev(i),&
!           Qprev(i),betaprev(i)),&
!          ObsRP(s1prev(i),s2prev(i),hprev(i),q1prev(i),q2prev(i),yprev(i),aprev(i),p1prev(i),p2prev(i),xprev(i),rprev(i),&
!           Qprev(i),betaprev(i)),&
!          ObsPA(s1prev(i),s2prev(i),hprev(i),q1prev(i),q2prev(i),yprev(i),aprev(i),p1prev(i),p2prev(i),xprev(i),rprev(i),&
!          Qprev(i),betaprev(i)),&
!         ObsLT(h0,aprev2(i),aprev(i),anext(i)),&
!          hnext(i),DSQRT(s1next(i)*s1next(i)+s2next(i)*s2next(i))
        !
!         WRITE(9,30) u,v(i),rnext(i)
!      END IF
!   END DO
!   WRITE(7,*)
!   WRITE(9,*)

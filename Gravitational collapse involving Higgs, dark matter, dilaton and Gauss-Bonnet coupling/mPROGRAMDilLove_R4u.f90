...
INTEGER :: licznik
REAL(8) :: R0,Rconst
INTEGER :: linieRconst,coile3d,R4uX
...
!******* wypisanie wartosci R4u do pliku **********************************************************
DO i=1,linieRconst
...
!DO i=1,30000
!   WRITE(99,25) i,dprev(i),q1prev(i),q2prev(i),yprev(i),s1prev(i),s2prev(i),hprev(i),aprev(i),&
!    p1prev(i),p2prev(i),xprev(i),rprev(i),fprev(i),gprev(i),Qprev(i),betaprev(i)
   !
!   WRITE(99,25) i,&
!    DerivAsymForward2pts(h0,dprev(i),dprev(i+1)),&
!    DerivAsymForward2pts(h0,q1prev(i),q1prev(i+1)),&
!    DerivAsymForward2pts(h0,q2prev(i),q2prev(i+1)),&
!    DerivAsymForward2pts(h0,yprev(i),yprev(i+1)),&
!    DerivAsymForward2pts(h0,s1prev(i),s1prev(i+1)),&
!    DerivAsymForward2pts(h0,s2prev(i),s2prev(i+1)),&
!    DerivAsymForward2pts(h0,hprev(i),hprev(i+1)),&
!    DerivAsymForward2pts(h0,aprev(i),aprev(i+1)),&
!    DerivAsymForward2pts(h0,p1prev(i),p1prev(i+1)),&
!    DerivAsymForward2pts(h0,p2prev(i),p2prev(i+1)),&
!    DerivAsymForward2pts(h0,xprev(i),xprev(i+1)),&
!    DerivAsymForward2pts(h0,rprev(i),rprev(i+1)),&
!    DerivAsymForward2pts(h0,fprev(i),fprev(i+1)),&
!    DerivAsymForward2pts(h0,gprev(i),gprev(i+1)),&
!    DerivAsymForward2pts(h0,Qprev(i),Qprev(i+1)),&
!    DerivAsymForward2pts(h0,betaprev(i),betaprev(i+1))
!END DO
...
!IF (licznik.EQ.15) THEN
!DO i=1,N
!   WRITE(99,25) i,dnext(i),q1next(i),q2next(i),ynext(i),s1next(i),s2next(i),hnext(i),anext(i),&
!    p1next(i),p2next(i),xnext(i),rnext(i),fnext(i),gnext(i),Qnext(i),betanext(i)
   !
!   WRITE(99,25) i,&
!    DerivAsymForward2pts(h0,dnext(i),dnext(i+1)),&
!    DerivAsymForward2pts(h0,q1next(i),q1next(i+1)),&
!    DerivAsymForward2pts(h0,q2next(i),q2next(i+1)),&
!    DerivAsymForward2pts(h0,ynext(i),ynext(i+1)),&
!    DerivAsymForward2pts(h0,s1next(i),s1next(i+1)),&
!    DerivAsymForward2pts(h0,s2next(i),s2next(i+1)),&
!    DerivAsymForward2pts(h0,hnext(i),hnext(i+1)),&
!    DerivAsymForward2pts(h0,anext(i),anext(i+1)),&
!    DerivAsymForward2pts(h0,p1next(i),p1next(i+1)),&
!    DerivAsymForward2pts(h0,p2next(i),p2next(i+1)),&
!    DerivAsymForward2pts(h0,xnext(i),xnext(i+1)),&
!    DerivAsymForward2pts(h0,rnext(i),rnext(i+1)),&
!    DerivAsymForward2pts(h0,fnext(i),fnext(i+1)),&
!    DerivAsymForward2pts(h0,gnext(i),gnext(i+1)),&
!    DerivAsymForward2pts(h0,Qnext(i),Qnext(i+1)),&
!    DerivAsymForward2pts(h0,betanext(i),betanext(i+1))
!END DO
!END IF
...
!******* wypisanie wartosci R4u do pliku **********************************************************
IF ((licznik.EQ.czyR4(R4uX-1)).OR.((licznik-Nkoniec).EQ.czyR4(R4uX-1-linieRconst))&
 .OR.((licznik-2*Nkoniec).EQ.czyR4(R4uX-1-2*linieRconst))) THEN
   R4uX=R4uX+1
   WRITE(8,10) rnext(1)
END IF

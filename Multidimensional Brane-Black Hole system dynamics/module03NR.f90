...
END INTERFACE
INTERFACE
    SUBROUTINE fdjac(x,fvec,df,h0,c0,c1,c2,c3,c4,c5,r,p1,p2,q1,q2,psi1,psi2,chi1,chi2,psi1P,psi2P,chi1P,chi2P)
    USE nrtype
    REAL(SP), DIMENSION(:), INTENT(IN) :: fvec
    REAL(SP), DIMENSION(:), INTENT(INOUT) :: x
    REAL(SP), DIMENSION(:,:), INTENT(OUT) :: df
    REAL(SP), INTENT(IN) :: h0,c0,c1,c2,c3,c4,c5
    REAL(SP), DIMENSION(:), INTENT(IN) :: r,p1,p2,q1,q2,psi1,psi2,chi1,chi2,psi1P,psi2P,chi1P,chi2P
...
END INTERFACE
INTERFACE
    SUBROUTINE newt(x,check,h0,c0,c1,c2,c3,c4,c5,r,p1,p2,q1,q2,psi1,psi2,chi1,chi2,psi1P,psi2P,chi1P,chi2P)
    USE nrtype
    REAL(SP), DIMENSION(:), INTENT(INOUT) :: x
    LOGICAL(LGT), INTENT(OUT) :: check
    REAL(SP), INTENT(IN) :: h0,c0,c1,c2,c3,c4,c5
...
END INTERFACE
INTERFACE
    SUBROUTINE odeint(ystart,x1,x2,eps,h1,hmin,derivs,rkqs,c0,c1,c2,c3,c4,c5,r,p1,p2,q1,q2,psi1,psi2,chi1,chi2,psi1P,psi2P&
     ,chi1P,chi2P)
    USE nrtype
    REAL(SP), DIMENSION(:), INTENT(INOUT) :: ystart
    REAL(SP), INTENT(IN) :: x1,x2,eps,h1,hmin
    REAL(SP), INTENT(IN) :: c0,c1,c2,c3,c4,c5
    REAL(SP), DIMENSION(:), INTENT(IN) :: r,p1,p2,q1,q2,psi1,psi2,chi1,chi2,psi1P,psi2P,chi1P,chi2P
    INTERFACE
        SUBROUTINE derivs(x,y,dydx,c0,c1,c2,c3,c4,c5,r,p1,p2,q1,q2,psi1,psi2,chi1,chi2,psi1P,psi2P,chi1P,chi2P,j)
        USE nrtype
        REAL(SP), INTENT(IN) :: x
        REAL(SP), DIMENSION(:), INTENT(IN) :: y
        REAL(SP), DIMENSION(:), INTENT(OUT) :: dydx
...
END INTERFACE
INTERFACE
    SUBROUTINE rk4(y,dydx,x,h,yout,derivs,c0,c1,c2,c3,c4,c5,r,p1,p2,q1,q2,psi1,psi2,chi1,chi2,psi1P,psi2P,chi1P,chi2P,j)
    USE nrtype
    REAL(SP), DIMENSION(:), INTENT(IN) :: y,dydx
    REAL(SP), INTENT(IN) :: x,h
    REAL(SP), DIMENSION(:), INTENT(OUT) :: yout
...
END INTERFACE
INTERFACE
    SUBROUTINE rkck(y,dydx,x,h,yout,yerr,derivs,c0,c1,c2,c3,c4,c5,r,p1,p2,q1,q2,psi1,psi2,chi1,chi2,psi1P,psi2P,chi1P,chi2P)
    USE nrtype
    REAL(SP), DIMENSION(:), INTENT(IN) :: y,dydx
    REAL(SP), INTENT(IN) :: x,h
...
END INTERFACE
INTERFACE
    SUBROUTINE rkdumb(vstart,x1,x2,nstep,derivs,c0,c1,c2,c3,c4,c5,r,p1,p2,q1,q2,psi1,psi2,chi1,chi2,psi1P,psi2P,chi1P,chi2P)
    USE nrtype
